...
<meta charset="utf-8" />
    ...
    <body>
        <header>
            <div id = "head">
                <h1><a href="/top"><img src="{{asset('images/know.white.png')}}" class="logo-image"></a></h1>
                <div id="head-parts">
                    <div id="head-item">
                        <div class="header-names">
                            <p class="head-name text-white">{{Auth::user()->username}}</p>
                    ...
                    <div id="side-bar">
                        <div id="confirm">
                            ...
                            <div class="index-button">
                                <p class="btn btn-dark follow-page box1"><a href="/follow-list" class="confirm-button follow-list-button">フォローリスト</a></p>
                            </div>
                            <div class="confirm-follow">
                            ...
                            <div class="index-button">
                                <p class="btn btn-dark follower-page box1"><a href="/follower-list" class="confirm-button follow-list-button">フォロワーリスト</a></p>
                            </div>
                        </div>
                        <div class="confirm-search">
                            <p class="btn btn-dark post_del_btn search-page box1"><a class="confirm-button search-btn" href="/search">ユーザー検索</a></p>
                        </div>
